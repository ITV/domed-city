...
module Dome
  class Secrets
    ...
    def secret_env_vars
      return if dome_config.nil?

      @secretsmanager.secret_env_vars(secretsmanager_config) unless secretsmanager_config.nil?
      @hiera.secret_env_vars(hiera_keys_config) unless hiera_keys_config.nil?
    end
